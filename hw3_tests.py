...
class TestCases(unittest.TestCase):
    ...
    def test_filter_by_state_2(self):
        filtered_counties_no = filter_by_state(reduced_data, 'XY')  # Assuming 'XY' doesn't exist
